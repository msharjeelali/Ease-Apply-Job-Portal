 ...
 * Use the [RecruiterRegisterFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class RecruiterRegisterFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_recruiter_register, container, false)
    }
    ...
    companion object {
         ...
         * @return A new instance of fragment RecruiterRegisterFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RecruiterRegisterFragment().apply {
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(email, password)
                        .addOnCompleteListener { task ->
                            if (task.isSuccessful) {
                                ...
                                val userData = Employer("employer", name, email, phone)
                                    ...
                                    usersRef.child(uid).setValue(userData)
                                        .addOnSuccessListener {
                                            ...
                                            startActivity(
                                                Intent(
                                                    requireContext(),
                                                    EmployerDashboardActivity::class.java
                                                )
                                            )
